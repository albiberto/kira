...
public static class JqlExtensions
{
    ...
    public static IEnumerable<(string Field, string Order)> ToOrderClause(this LoadDataArgs args) => args.Sorts.Select(sort => (sort.Property.Contains(' ') ? $@"""{sort.Property}""" : sort.Property, sort.SortOrder == SortOrder.Ascending ? "ASC" : "DESC"));
}